...
module.exports = {
    ...
    // Release 9 (04/09/2026): extractFromText, nova função exportada por
    // lib/claude.js e lib/gemini.js pra extração regime/rotulo a partir de
    // texto solto (item 4.25) — precisa ser despachada aqui igual às outras,
    // senão qualquer AI_PROVIDER != 'claude' quebra com "... is not a
    // function" no primeiro texto marcado como "compromisso", do mesmo jeito
    // que já aconteceu duas vezes antes com applyCorrection (ver comentário
    // no topo deste arquivo).
    extractFromText: (...args) => dispatch('extractFromText', args),
